cc.Class({
    ...
    initMahjongs:function(){
        ...
        console.log('initMahjongs >> holds',holds);
        //初始化手牌
        ...
        //     if(isNaN(seatData.diangangs[i])){
        //         //非数字
        //         var paistr=seatData.diangangs[i];
        //         if(paistr.splice(',').length==3){
        //         }
        //     }
        // }
        console.log('initMahjongs >> lackingNum',lackingNum);
        for(var i = 0; i < holds.length; ++i){
            var mjid = holds[i];
    ...
    checkQueYiMen:function(){
        if(cc.vv.gameNetMgr.conf.type == "mhmj" || cc.vv.gameNetMgr.conf.type == "mhmjdxj"){
