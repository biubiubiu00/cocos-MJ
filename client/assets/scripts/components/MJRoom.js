cc.Class({
    ...
    onBtnWeichatClicked:function(){
        ...
        if(cc.vv.gameNetMgr.conf.type == "xlch"){
            var title = "<血流成河>";
        }else if(cc.vv.gameNetMgr.conf.type == "mhmj"){
            var title = "<梅河麻将>";
        }else if(cc.vv.gameNetMgr.conf.type == "mhmjdxj"){
            var title = "<梅河麻将小鸡飞蛋>";
        }

        cc.vv.anysdkMgr.share("梅河麻将" + title,"房号:" + cc.vv.gameNetMgr.roomId + " 玩法:" + cc.vv.gameNetMgr.getWanfa());
    },
